	...
	return (
		<div className="flex flex-col gap-4">
			<div className="flex flex-col gap-1">
				<p className=" uppercase text-4xl text-white">{game?.name}</p>
				<p>Join Code: { game?.joinCode }</p>
			</div>
			<div className="flex gap-4">
				<div className="bg-muted p-4 border-l-2 border-primary rounded-md flex-grow text-lg  uppercase tracking-wide max-w-1/2">
					<p className="text-sm">Leaderboard:</p>
					<p className="text-2xl text-primary">#4</p>
				</div>
				<div className="bg-muted p-4 border-l-2 border-primary rounded-md flex-grow text-lg  uppercase tracking-wide">
